 ...
 */
class tx_nkwkeywords_pi2 extends tslib_pibase {
...
if (defined('TYPO3_MODE') 
	&& $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/nkwkeywords/pi2/class.tx_nkwkeywords_pi2.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/nkwkeywords/pi2/class.tx_nkwkeywords_pi2.php']);
}
?>