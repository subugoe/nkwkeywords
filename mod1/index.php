 ...
 */
class tx_nkwkeywords_module1 extends \TYPO3\CMS\Backend\Module\BaseScriptClass {
	...
	function init() {
		...
		parent::init();
		$this->modTSconfig = \TYPO3\CMS\Backend\Utility\BackendUtility::getModTSconfig($id, 'mod.' . $GLOBALS['MCONF']['name']);
	}
	...
	function main() {
		...
		$this->doc->setModuleTemplate(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('nkwkeywords') . 'mod1/mod_template.html');
	...
	function moduleContent() {
		...
		$confVars['properties']['savehere'] = 294;
...
// Make instance:
$SOBE = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('tx_nkwkeywords_module1');
$SOBE->init();
// Include files?
